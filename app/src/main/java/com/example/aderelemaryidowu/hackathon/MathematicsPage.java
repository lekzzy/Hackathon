...
public class MathematicsPage extends AppCompatActivity {
    RadioGroup radioG1;
    RadioGroup radioG2;
    RadioGroup radioG3;
    RadioGroup radioG4;
    ...
    {
        if(radioG1.getCheckedRadioButtonId() == R.id.option_2)
        {
            score = score + 1;
        }
        else
        ...
        if(radioG2.getCheckedRadioButtonId()== R.id.option_c)
        {
            score = score + 1;
        }
        else
        ...
        if(radioG3.getCheckedRadioButtonId()== R.id.option_d3)
        {
            score = score + 1;
        }
        else
